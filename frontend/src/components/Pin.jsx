...
import {BsFillArrowUpRightSquareFill, BsYoutube} from 'react-icons/bs'
    ...
    return(
      <div className='m-2'>
                ...
                >
                    <div className='flex items-center justify-between'>
                        ...
                        {alreadySaved  ? (
                            ...
                            type='button' 
                            className='bg-red-500 opacity-70 text-dark hover:opacity-100 text-white font-bold px-5 py-1 text-base rounded-3xl hover:shadow-md outlined-none'>
                                Save
                            </button>
                        )}
                    ...
                    <div className='flex justify-between w-full items-center gap-2'>
                            {destination &&(
                                ...
                                target='_blank'
                                rel='noreferrrer'
                                className='bg-white flex items-center gap-2 text-black text-sm font-bold p-2 pl-4 pr-4 rounded-full opacity-70 hover:opacity:100 hover:shadow-md'
                                >
        ...
        <Link to={`user-profile/${postedBy?._id}`} className='flex gap-2 mt-2 items-center'>
            ...
            src={postedBy?.image}
            />  
            <p className='font-semibold captalize'>{postedBy?.userName}</p>    
        </Link>
